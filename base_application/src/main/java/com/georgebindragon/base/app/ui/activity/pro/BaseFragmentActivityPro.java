...
import com.georgebindragon.base.app.ui.activity.base.BaseFragmentActivity;
...
public abstract class BaseFragmentActivityPro extends BaseFragmentActivity
{
	...
	public void finish()
	{
		overridePendingTransition(com.qmuiteam.qmui.arch.R.anim.slide_in_right, com.qmuiteam.qmui.arch.R.anim.slide_out_left);//页面切换方式
		super.finish();
	}
